...
# Generic name
model_name = "ZU+ Series, unknown model"
...
_commands = {
    ...
    0b01101: "DESYNC   (Reset the DALIGN Signal)",
...
_regs = {
    ...
    0b01000: "LOUT    (Legacy Output Register for daisy chain)",
    0b01001: "COR0    (Configuration Option Register 0)",
    0b01010: "MFWR    (Multiple Frame Write Register)",
    0b01011: "CBC     (Initial CBC Value Register)",  # (according to UG470. This is incorrect; it's actually 0b10011)
    0b01100: "IDCODE  (Device ID Register)",
    0b01101: "AXSS    (User Access Register)",
    ...
    0b11111: "BSPI    (BPI/SPI Configuration Options Register",

    0b10011: "CBC     (Initial CBC Value Register) (Wrongly documented; typo in UG470)",
}
